...
const Hero = () => {
  ...
  return <>
      <section className="relative h-screen flex items-center justify-center text-center overflow-hidden bg-gradient-to-br from-[#FBF9F6] via-[#FDE68A]/10 to-[#A997AB]/10">
